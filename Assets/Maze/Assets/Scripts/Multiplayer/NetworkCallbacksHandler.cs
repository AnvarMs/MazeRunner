...
{
    [SerializeField] private SimpleLobbyManager lobbyManager;
    ...
    public void OnPlayerJoined(NetworkRunner runner, PlayerRef player)
    {
        ...
        if (lobbyManager != null)
            lobbyManager.OnConnectedToSession();
    }
    ...
    {
        // Input is handled by NetworkInputProvider
    }
